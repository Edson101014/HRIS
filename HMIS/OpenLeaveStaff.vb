...
Public Class OpenLeaveStaff
    ...
    Private Sub btnSelect_Click(sender As Object, e As EventArgs) Handles btnSelect.Click
        Try
            With Me
                Staff.TextBoxLeaveId.Text = .DataGridView1.CurrentRow.Cells(0).Value
                Staff.TextBoxLeaveName.Text = .DataGridView1.CurrentRow.Cells(1).Value
                Staff.LeaveDepartment.Text = .DataGridView1.CurrentRow.Cells(2).Value.ToString
                Staff.LeavePosition.Text = .DataGridView1.CurrentRow.Cells(3).Value.ToString
                Staff.LeaveSalary.Text = .DataGridView1.CurrentRow.Cells(4).Value.ToString
