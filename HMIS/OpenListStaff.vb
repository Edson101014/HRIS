...
Public Class OpenListStaff
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Try
            With Me
                Staff.TextBoxPayID.Text = .DataGridView1.CurrentRow.Cells(0).Value
                Staff.TextBoxPayName.Text = .DataGridView1.CurrentRow.Cells(1).Value
                Staff.TextBoxPayrate.Text = .DataGridView1.CurrentRow.Cells(2).Value.ToString
                Staff.TextBoxPayHour.Text = .DataGridView1.CurrentRow.Cells(3).Value.ToString
                Staff.TextBoxPayWork.Text = .DataGridView1.CurrentRow.Cells(4).Value.ToString
